...
You can choose to deploy to device straight to iTunes or just create an adhoc build which you can either manually install to your device, distribute to your testers or manually upload to TestFlight.
...
You can change the certificate being used with the following flag:
