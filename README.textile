...
It builds your code, it highlights the console output... thats it! No analytics and no crap, just gets the job done!

Currently only for mac (expanding that soon, and does not YET support mobile web SDK).
