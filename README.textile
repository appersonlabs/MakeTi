...
To do this go to _*Preferences->Advanced->Shell variables__, add a new variable named **ANDROID_SDK_PATH** and set the path to the location of your Android SDK. (in my case is /android-sdk-mac_x86).
